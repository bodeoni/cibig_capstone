...
#SBATCH --output=/projects/Whitefly_RNASeq/98_test_run/99_logs/approach1_star_%j.log
#SBATCH --error=/projects/Whitefly_RNASeq/98_test_run/99_logs/approach1_star_%j.err
#SBATCH --cpus-per-task=16
#SBATCH --mem=32G

# ================================================================================
# APPROACH 1: STAR Alignment with Quantification on Decontaminated Reads
# ================================================================================
# Input: Decontaminated reads from HISAT2 (unmapped to contaminants)
...
INPUT_DIR="${PROJECT_DIR}/01_data/02_hisat_decontam"
OUTPUT_DIR="${PROJECT_DIR}/02_analysis/approach1_star"
...
STAR_INDEX="${REF_DIR}/star_index"  # Directory for STAR index
...
echo "=========================================="
echo "APPROACH 1: STAR with GeneCounts"
echo "=========================================="
echo "Started: $(date)"
...
for SAMPLE in "${SAMPLES[@]}"; do
    ...
    # Input files
    READ1="${INPUT_DIR}/${SAMPLE}_unmapped.fastq.1.gz"
    READ2="${INPUT_DIR}/${SAMPLE}_unmapped.fastq.2.gz"
...
BAM_FILES=""
for SAMPLE in "${SAMPLES[@]}"; do
    BAM_FILES="${BAM_FILES} ${OUTPUT_DIR}/bam/${SAMPLE}_Aligned.sortedByCoord.out.bam"
done
